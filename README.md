...
This repository is the official implementation of "*DEMA: Data-Enhanced Model Aggregation with Dual Uncertainty for Heterogeneous Data Integration*".
...
- **sim_codes**  
  ...
  - Table2_design2.r: results of Table2 (Design 2);
  - Table3_LUAD.r: results of Table 3 (LUAD);
